    ...
    <tbody>
      ...
      <tr class="align-middle">
        ...
        <td class="align-middle">
          <div class="d-flex justify-content-center">
            <a href="{{route('band.show', $iten->id)}}"><i class="bi bi-eye" style="padding-right: 25px; font-size: 25px; color: #989898"></i></a>
            @auth
            <a href="{{route('band.view', $iten->id)}}"><i class="bi bi-pencil" style="padding-right: 25px; color: #989898"></i></a>
            @if (Auth::user()->userType == 1)
            <a href="{{route('band.delete', $iten->id)}}"><i class="bi bi-trash3" style="padding-right: 5px; color: #989898"></i></a>
            @endif
          </div>
          @endauth     
        </td>
