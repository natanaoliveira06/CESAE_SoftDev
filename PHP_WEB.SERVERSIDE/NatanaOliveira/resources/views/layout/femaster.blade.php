    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div>
        ...
        <ul class="navbar-nav">
          ...
          @else
          <li class="nav-item">
            <a class="btn-nav" href="{{ route('login') }}" ><i class="bi bi-person"></i> Login</a>    {{-- usa o metodo da rota --}}
          </li>
          <li class="nav-item">
            {{-- @if (Route::has('users.add')) --}}
            <a class="btn-nav"  href="{{ route('user.add') }}"><i class="bi bi-person-add"></i> Register</a>
            {{-- @endif --}}
         </li>
         @endauth
        </ul>
