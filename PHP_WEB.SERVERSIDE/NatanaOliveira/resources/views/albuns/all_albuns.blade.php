      ...
      <tr class="align-middle">
        ...
        <td class="align-middle">
          <div class="d-flex justify-content-center">
            <a href="{{route('album.show', $iten->id)}}"><i class="bi bi-eye" style="padding-right: 25px; font-size: 25px; color: #989898"></i></a>
            @auth
            <a href="{{route('album.view', $iten->id)}}"><i class="bi bi-pencil" style="padding-right: 25px; font-size: 20px; color: #989898"></i></a>
            @if (Auth::user()->userType == 1)
            <a href="{{route('album.delete', $iten->id)}}"><i class="bi bi-trash3" style="padding-right: 5px; font-size: 20px; color: #989898"></i></a>
            @endif
            @endauth
          </div>          
        </td>        
